...
var CRUDResource = function (_Resource_1$Resource) {
    ...
    CRUDResource.prototype._listRoute = function _listRoute(pathParams, required) {
        return this.defineRoute("GET", this._routeBase, pathParams, required);
    };

    CRUDResource.prototype._createRoute = function _createRoute(pathParams, required) {
        return this.defineRoute("POST", this._routeBase, pathParams, required);
    };

    CRUDResource.prototype._getRoute = function _getRoute(pathParams, required) {
        return this.defineRoute("GET", this._routeBase + "/:id", pathParams, required);
    };

    CRUDResource.prototype._updateRoute = function _updateRoute(pathParams, required) {
        return this.defineRoute("PATCH", this._routeBase + "/:id", pathParams, required);
    };

    CRUDResource.prototype._deleteRoute = function _deleteRoute(pathParams, required) {
