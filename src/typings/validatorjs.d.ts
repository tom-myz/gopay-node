declare namespace ValidatorJS {
    ...
    interface ValidatorConstructor<A> {
        new (data: A, rules: any, customMessages?: ErrorMessages): Validator<A>
...
declare const ValidatorJs: ValidatorJS.ValidatorConstructor<any>
